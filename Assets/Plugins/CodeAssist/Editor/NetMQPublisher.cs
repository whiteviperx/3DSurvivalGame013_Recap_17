...
namespace Meryel.UnityCodeAssist.Editor
	...
	public class NetMQPublisher:Synchronizer.Model.IProcessor
		...
		private readonly Synchronizer.Model.Manager syncMngr;

		public List<Synchronizer.Model.Connect> clients;

		private Synchronizer.Model.Connect? _self;

		private Synchronizer.Model.Connect Self => _self!;
		...
		private void SendAux(Synchronizer.Model.IMessage message, bool logContent = true)
			{
			if (message == null)
				return;
