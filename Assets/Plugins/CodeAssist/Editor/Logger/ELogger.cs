...
namespace Meryel.UnityCodeAssist.Editor.Logger
	...
	public static class ELogger
		...
		private const Serilog.Events.LogEventLevel fileMinLevel = Serilog.Events.LogEventLevel.Debug;

		private const Serilog.Events.LogEventLevel outputWindowMinLevel = Serilog.Events.LogEventLevel.Information;
